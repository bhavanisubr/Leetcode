 ...
 * the same color are adjacent, with colors in the order red, white and blue respectively.
 * Here, we use integers 0, 1, and 2 to represent colors red, white, and blue respectively.
 * 
